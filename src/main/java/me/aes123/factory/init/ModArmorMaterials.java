...
public enum ModArmorMaterials implements StringRepresentable, ArmorMaterial {
    ...
    private ModArmorMaterials(String p_268171_, float p_268303_, EnumMap<ArmorItem.Type, Integer> p_267941_, int p_268086_, SoundEvent p_268145_, float p_268058_, float p_268180_, Supplier<Ingredient> p_268256_) {
        this.name = p_268171_;
    ...
    public int getDurabilityForType(ArmorItem.Type p_266745_) {
        return (int)Math.ceil(HEALTH_FUNCTION_FOR_TYPE.get(p_266745_) * this.durabilityMultiplier);
    }
