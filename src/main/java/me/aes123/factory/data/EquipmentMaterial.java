...
public class EquipmentMaterial {
    public static Map<String, EquipmentMaterial> EQUIPMENT_MATERIALS = Map.of(
            "iron", new EquipmentMaterial(6,0.6f,6,3,1,900,4, 450),
            "gold", new EquipmentMaterial(22,0.5f,5,2,0.65f,150,4, 90),
            "diamond", new EquipmentMaterial(8,0.6f,8,4,0.9f,6000,6, 3000),
            "netherite", new EquipmentMaterial(16,0.5f,16,7,0.8f,18000,11, 9000)
    );
